...
public class HabenSein extends AppCompatActivity {
    ...
    String[] sentenses = {"Ich habe gestern Fußball gespielt.", "Ich bin gestern ins Kino gegangen.",
            ...
            "Ihr habt am Wochenende einen Ausflug gemacht.", "Ihr habt gestern viel gemacht.",
            ...
            "Du hast gestern einen Film geschaut.", "Du hast gestern im See geschwommen.",
            ...
            "Ich habe gestern eine Nachricht geschickt.", "Ich habe gestern das Theater besucht.",
            "Er hat gestern am Computer gearbeitet.", "Er hat gestern im Schwimmbad geschwommen.",
            ...
            "Sie haben gestern Fotos gemacht.", "Sie haben gestern das Theater besucht.",
            ...
            "Ich habe gestern im Fitnessstudio trainiert.","Ich habe gestern im Restaurant Wein getrunken.",
            ...
            "Wir haben gestern im Café Croissants gegessen.", "Wir haben gestern im Park Fußball gespielt.",
             "Sie haben gestern im Café Tee getrunken.", "Ich habe gestern im Café Kaffee getrunken.",
            "Er hat gestern im Schwimmbad geschwommen.", "Er hat gestern im Café ein Buch gelesen.",
            ...
            "Ich habe gestern im Museum alte Artefakte gesehen.", "Ich habe gestern im Café ein Buch gelesen.",
            "Wir haben gestern am Fluss gegrillt.", "Wir haben gestern im Restaurant Pizza bestellt.",
            ...
            "Er hat gestern im Café ein Buch gelesen.", "Er hat gestern im Café Tee getrunken.", "Sie ist gestern früh aufgestanden.",
    ...
    private void resetQuestion() {
        ...
        habenButton.setBackgroundColor(getResources().getColor(R.color.DarkBlue));
        seinButton.setBackgroundColor(getResources().getColor(R.color.DarkBlue));
    }
