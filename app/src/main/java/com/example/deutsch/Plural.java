...
public class Plural extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m = findViewById(R.id.relativeLayout);
    ...
    public void checkAnswer(View view) {
        ...
        if (userAnswer.equalsIgnoreCase(expectedAnswer)) {
            ...
            if(!answerEditText.getText().toString().isEmpty() && userAnswer.charAt(0)!='d'){
    ...
    public void help(View view) {
        Toast.makeText(this, "Richtige antwort ist " + words[1], Toast.LENGTH_LONG).show();
    }
}